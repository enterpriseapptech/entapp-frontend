              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">₦{booking.subTotal?.toLocaleString() || "0.00"}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Discount</span>
                    <span className="font-medium text-green-600">-₦{booking.discount?.toLocaleString() || "0.00"}</span>
                  </div>
                  <hr />
                  <div className="flex justify-between text-lg font-semibold">
                    <span>Total</span>
                    <span>₦{booking.total?.toLocaleString() || "0.00"}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Amount Paid</span>
                    <span className="font-medium">
                      {booking.paymentStatus === "PAID" 
                        ? `₦${booking.total?.toLocaleString() || "0.00"}` 
                        : "₦0.00"}
                    </span>
                  </div>
                  {booking.paymentStatus === "UNPAID" && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-red-600">₦{booking.total?.toLocaleString() || "0.00"}</span>
                    </div>
                  )}
                </div>
