          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-8 pr-3 py-2.5 border placeholder:text-gray-500 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
