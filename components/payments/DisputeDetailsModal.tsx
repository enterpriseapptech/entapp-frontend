          ...
          {showActions && (
            <div>
              ...
              <textarea
                ...
                className="w-full placeholder:text-gray-500 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                rows={3}
              />
            </div>
          )}
